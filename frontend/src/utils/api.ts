...
// Frame-count arithmetic, moved to ./videoChainMath. Re-exported so every
// existing import site is unchanged.
export {
  chainContextCapability,
  chainContinuationOverlapLengths,
  latentGroupSpans,
  snapRangeToLatentGroups,
  ...
  effectiveSegmentFrames,
} from "./videoChainMath";
export {
  trainableAdapterAlgorithms,
  decomposedAdapterFamily,
  weightDecomposeTrainable,
  adapterTrainingRefusalReason,
  trainingFeatureUnsupportedReason,
  trainingSampleParameterSupported,
  trainingSampleNote,
  cfgUncondDropDefault,
  trainingFeatureAdvisory,
  trainingRequiredValues,
  trainingMethodUnsupportedReason,
} from "./trainingCapabilities";
...
// Constraint readers, moved to ./archConstraints so this file keeps the
// client. Re-exported so every existing import site is unchanged.
export {
  VIDEO_BLOCK_SWAP_MAX,
  archDisplayName,
  archSupportsFeature,
  archSupportsRuntimeInt8,
  fitVideoCanvas,
  isOnGridVideoFrameCount,
...
export interface TrainingRun {
  ...
  current_step: number;
  total_steps: number;
  phase?: string;  // "initializing", "bucketing", "crop_precompute", "latent_cache", "text_encoder_cache", "training", "sampling"
...
export interface TrainingRunCreateRequest {
  ...
  qwen_cfg_null_sigma_schedule?: boolean;
