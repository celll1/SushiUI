# FBCache behavior and MiniMax-H3 safeguards
...
The temporal guard and hit-chain cap are adapted from the MIT-licensed
[MiniMax-H3 FirstBlockCache project](https://github.com/duckyshell/ComfyUI-MiniMaxH3-FirstBlockCache).
The upstream notice is retained in `docs/legal/licenses/MIT-FBCache.txt`.
