...
import { GenerationParams, Img2ImgParams, InpaintParams, OutpaintParams, OutpaintVideoParams, UpscaleParams, Txt2VidParams, Img2VidParams, Txt2AudParams, Aud2AudParams } from "@/utils/api";

export interface QueueItem {
  id: string;
  type: "txt2img" | "img2img" | "inpaint" | "outpaint" | "outpaint_vid" | "upscale" | "txt2vid" | "img2vid" | "txt2aud" | "aud2aud";
  params: GenerationParams | Img2ImgParams | InpaintParams | OutpaintParams | OutpaintVideoParams | UpscaleParams | Txt2VidParams | Img2VidParams | Txt2AudParams | Aud2AudParams;
