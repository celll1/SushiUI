...
export const PARAM_KEYS: (keyof TrainingRunCreateRequest)[] = [
  ...
  "fused_grad_clip_factor", "per_parameter_grad_probe", "fused_grad_clip_warmup_steps", "grad_spike_log_factor",
  ...
  "lr_group_schedules", "lr_layer_decay",
  ...
  "chimera_bridge_lr", "chimera_context_dropout",
  "chimera_clip_hidden_weight", "chimera_clip_pooled_weight",
  "block_swap_h2d_only", "block_swap_ring_size", "num_optimizer_groups",
  "bundle_vae",
  "activation_dispatch_enable", "activation_dispatch_allow_batch_reduction",
  "activation_dispatch_margin_gb",
  "activation_dispatch_seed_coef", "activation_dispatch_residual_frac",
  "activation_dispatch_threshold_mb", "activation_offload_transfer_mode",
  ...
  "qwen_convrot_backward_cache_blocks", "qwen_convrot_backward_prefetch_depth",
  "qwen_guidance_loss_weight", "qwen_guidance_loss_mix_mode", "qwen_cfg_null_sigma_schedule",
  "qwen_guidance_loss_scale", "qwen_guidance_loss_schedule",
  ...
  "sensenova_noise_scale_gain", "sensenova_noise_scale_auto",
