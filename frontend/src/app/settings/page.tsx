              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Show advanced CFG (Classifier-Free Guidance) settings in generation panels. Includes Dynamic CFG Schedule (noise-to-clean progress, SNR-based), Dynamic Thresholding, and related parameters. When disabled, all advanced CFG features are turned off.
                    </p>
                  </div>
                </div>
