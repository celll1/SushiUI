...
| [AGENTS.md](../../AGENTS.md) | Repository rules and task router for coding agents. |
| [docs/README.md](../README.md) | Documentation taxonomy, privacy rules, and review checklist. |
| [docs/guides/DOC_MAP.md](DOC_MAP.md) | This detailed index. |

## Architecture and development guides

| Document | Purpose |
|---|---|
| [docs/guides/ARCHITECTURE_MAP.md](ARCHITECTURE_MAP.md) | Backend/frontend ownership map. |
| [docs/reference/architectures/](../reference/architectures/README.md) | Per-architecture components, load path, tensor contract, and hook points. |
| [docs/guides/REQUEST_LIFECYCLE.md](REQUEST_LIFECYCLE.md) | Generation request flow from frontend to persistence. |
| [docs/guides/ADD_A_PARAMETER.md](ADD_A_PARAMETER.md) | End-to-end parameter checklist. |
| [docs/guides/ADD_A_MODEL_ARCHITECTURE.md](ADD_A_MODEL_ARCHITECTURE.md) | Architecture integration checklist. |
| [docs/guides/API_TESTING.md](API_TESTING.md) | Safe API verification procedures. |
| [docs/guides/DATABASE_MIGRATION.md](DATABASE_MIGRATION.md) | SQLite schema migration procedure. |
| [docs/guides/GENERATION_QUEUE_PROCESSOR.md](GENERATION_QUEUE_PROCESSOR.md) | Frontend queue ownership and dispatch invariants. |

## Generation behavior

| Document | Purpose |
|---|---|
| [docs/guides/MODEL_FACTS.md](MODEL_FACTS.md) | Per-architecture generation, training, and adapter facts. |
| [docs/guides/CFG_UNCONDITIONAL_TRAINING.md](CFG_UNCONDITIONAL_TRAINING.md) | CFG and unconditional-training audit. |
| [docs/guides/FBCACHE.md](FBCACHE.md) | FBCache acceptance rules and video safeguards. |
| [docs/guides/NAG.md](NAG.md) | Normalized Attention Guidance behavior and hooks. |
...
| [docs/guides/QWEN_IMAGE_21_BRANCH_LORA_DESIGN.md](QWEN_IMAGE_21_BRANCH_LORA_DESIGN.md) | Proposed Qwen conditional/empty-branch LoRA separation, loss routing, negative-prompt policy, and checkpoint contract. |
| [docs/guides/QWEN_IMAGE_21_BRANCH_LORA_EVALUATION.md](QWEN_IMAGE_21_BRANCH_LORA_EVALUATION.md) | Paired Run 156 CFG branch-rollout plan and subsequent split-adapter acceptance gates. |
...
| [docs/plans/RESUME_DATASET_REBASE_DESIGN_2026-09.md](../plans/RESUME_DATASET_REBASE_DESIGN_2026-09.md) | Proposed mid-epoch batch-plan revision after adding or deselecting training datasets. |
...
| [docs/guides/VAE_SWAP_MIGRATION_DESIGN.md](VAE_SWAP_MIGRATION_DESIGN.md) | Implemented VAE replacement and compatibility contract. |
| [backend/core/training/API_REFERENCE.md](../../backend/core/training/API_REFERENCE.md) | Training API reference. |
| [backend/core/training/TRAINING_PARAMS_GUIDE.md](../../backend/core/training/TRAINING_PARAMS_GUIDE.md) | Training parameters and configuration. |
| [backend/core/training/MODEL_ARCHITECTURES.md](../../backend/core/training/MODEL_ARCHITECTURES.md) | Per-architecture training internals. |
| [backend/core/training/adapters/MODEL_ADAPTER_DESIGN.md](../../backend/core/training/adapters/MODEL_ADAPTER_DESIGN.md) | Model-adapter pattern. |
| [backend/core/training/INT8_W8A8_TRAINING_GATE.md](../../backend/core/training/INT8_W8A8_TRAINING_GATE.md) | Registered quantized-training gates and results. |
...
| Document | Purpose |
|---|---|
| [backend/api/WS_PROTOCOL.md](../../backend/api/WS_PROTOCOL.md) | WebSocket progress protocol. |
| [backend/backups/README.md](../../backend/backups/README.md) | Backup directory conventions. |
| [examples/api/README.md](../../examples/api/README.md) | API example scripts and measurement gates. |
| [subapps/aesthetic_scorer/README.md](../../subapps/aesthetic_scorer/README.md) | Aesthetic scorer overview. |
| [subapps/aesthetic_scorer/USAGE.md](../../subapps/aesthetic_scorer/USAGE.md) | Aesthetic scorer usage. |
| [subapps/fp8_quantize/README.md](../../subapps/fp8_quantize/README.md) | FP8 checkpoint quantizer. |
| [subapps/layer_pruning/README.md](../../subapps/layer_pruning/README.md) | Layer-pruning utility. |

## Legal and agent support

| Document | Purpose |
|---|---|
| [docs/audits/DOCUMENTATION_HYGIENE_2026-09.md](../audits/DOCUMENTATION_HYGIENE_2026-09.md) | Publication-boundary audit and cleanup plan. |
| [docs/legal/THIRD_PARTY_PROVENANCE.md](../legal/THIRD_PARTY_PROVENANCE.md) | Vendored/adapted source ledger and redistribution gate. |
| [.claude/agents/arch-maintainer.md](../../.claude/agents/arch-maintainer.md) | Architecture-maintenance agent definition. |
| [.claude/agents/api-tester.md](../../.claude/agents/api-tester.md) | API-test agent definition. |
| [.claude/agents/code-auditor.md](../../.claude/agents/code-auditor.md) | Code-audit agent definition. |
| [.claude/agents/docs-maintainer.md](../../.claude/agents/docs-maintainer.md) | Documentation-maintenance agent definition. |
| [.claude/agents/feature-worker.md](../../.claude/agents/feature-worker.md) | Feature implementation agent definition. |
| [.claude/agents/orchestrator.md](../../.claude/agents/orchestrator.md) | Multi-workstream orchestration definition. |
| [.claude/agents/research-integrator.md](../../.claude/agents/research-integrator.md) | Research assessment and clean-room boundary definition. |
| [local/README.md](../../local/README.md) | Rules for the ignored machine-local working area. |
