...
"d:\celll1\webui_cl\venv\Scripts\python.exe" subapps/layer_pruning/extract_samples.py ^
...
"d:\celll1\webui_cl\venv\Scripts\python.exe" subapps/layer_pruning/prune_layers.py ^
...
"d:\celll1\webui_cl\venv\Scripts\python.exe" subapps/layer_pruning/evaluate_pruned.py ^
