...
#
# Vendored verbatim (import paths adjusted only) from
# `pid/_src/networks/pid_net.py` in github.com/nv-tlabs/PiD.
# `pid._ext.imaginaire.utils.log` -> `core.models.pid.utils.log` (stdlib logging stub).
...
from core.models.pid.utils import log
from core.models.pid.networks.lq_projection_2d import LQProjection2D
from core.models.pid.networks.pixeldit_official import PixDiT_T2I
...
class PidNet(PixDiT_T2I):
    ...
    def __init__(
        ...
        if pit_lq_inject:
            from core.models.pid.networks.lq_projection_2d import _build_gate
