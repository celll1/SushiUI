              ...
              {refImagePreviews.length === 0 ? (
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    💡 {refImages.length}/{maxRefImages} images. {refImages.length < maxRefImages ? 'Drop more images in the area above' : 'Max reached'}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {supportsImgCfgScale && (
                <Slider
                  ...
                  max={10.0}
                  step={0.1}
                  value={params.img_cfg_scale ?? generationDefaults?.txt2img?.img_cfg_scale ?? 1.0}
              ...
              {supportsCfgNorm && (
                <Select
                  ...
                  value={params.cfg_norm ?? generationDefaults?.txt2img?.cfg_norm ?? "global"}
