            ...
            <>
              ...
              {chainPlan != null
                ? ` Reaching it takes ${chainPlan.segments} generation requests (actually reaches ${chainPlan.finalFrames} frames` +
                  ...
                  ` the first are conditioned on the boundary frame of the previous segment, not the rest of its content.` +
                  ` Generate opens a plan you can review and edit, in which each segment carries its own prompt; it also asks you` +
                  ` to choose between a single inference at the cap and the chain.`
                : ""}
            </>
          ) : (
            <>
              ...
              {chainPlan != null
                ? ` A chain segment length is set, so reaching it takes ${chainPlan.segments} generation requests (actually reaches` +
                  ...
                  ` content. Generate opens a plan you can review and edit, in which each segment carries its own prompt.`
                : ""}
            </>
          )}
        </p>
