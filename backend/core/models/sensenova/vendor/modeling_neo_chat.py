...
# helper methods (`patchify`/`unpatchify`, `_build_t2i_query`,
# `_build_t2i_text_inputs`, `_build_t2i_image_indexes`, `_t2i_prefix_forward`,
# `_t2i_predict_v`, `_apply_time_schedule`, `prepare_flash_kv_cache`/
# `clear_flash_kv_cache`, `_notify_layer_offload_phase`) directly, the same
# reason MiniMax-H3's Modular-Diffusers blocks are not vendored (see
# `backend/core/models/minimax_h3/vendor/__init__.py`).
#
# Source: https://github.com/OpenSenseNova/SenseNova-U1, branch `feat/u1.5`
#         (commit a1ce053d25835e0785a0869ca1c97e717212ef64), file
#         `src/sensenova_u1/models/neo_unify/modeling_neo_chat.py`, retrieved 2026-08-21.
