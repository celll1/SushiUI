...
| `backend/core/training/INT8_W8A8_TRAINING_GATE.md` | Pre-registered measurement gate **G3**: whether a gradient-capable INT8 W8A8 forward path may be built for training at all (the inference gates G1/G2 are in `examples/api/README.md`). |
