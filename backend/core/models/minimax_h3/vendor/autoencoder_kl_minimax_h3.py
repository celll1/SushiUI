...
#
# Source: https://github.com/huggingface/diffusers, branch `minimax-h3`
#         (PR #14355 "Add MiniMax-H3" + PR #14371 "Minimax h3 follow up"),
#         file `src/diffusers/models/autoencoders/autoencoder_kl_minimax_h3.py`, retrieved 2026-08-05.
# Upstream file license: Apache-2.0 (see the copyright header below).
#
# The MiniMax-H3 *weights* this code consumes are covered by the MiniMax H3
# Community License Agreement, which requires modified files to be marked.
# This file is marked as modified accordingly.
#
...
# architectures and must not be pinned to an unmerged dev branch.
