...
VIDEO_GEN_DEFAULTS: Dict[str, Any] = {
    ...
    # H3 rotary-coordinate radii. Time uses the model's rescaled frame clock;
...
TRAINING_DEFAULTS: Dict[str, Any] = {
    ...
    "sample_cfg_schedule_type": GENERATION_DEFAULTS["cfg_schedule_type"],
    "sample_cfg_schedule_min": GENERATION_DEFAULTS["cfg_schedule_min"],
    "sample_cfg_schedule_max": GENERATION_DEFAULTS["cfg_schedule_max"],
    "sample_cfg_schedule_power": GENERATION_DEFAULTS["cfg_schedule_power"],
    "sample_cfg_rescale_snr_alpha": GENERATION_DEFAULTS["cfg_rescale_snr_alpha"],
    "sample_dynamic_threshold_percentile": GENERATION_DEFAULTS["dynamic_threshold_percentile"],
    "sample_dynamic_threshold_mimic_scale": GENERATION_DEFAULTS["dynamic_threshold_mimic_scale"],
    "sample_nag_enable": GENERATION_DEFAULTS["nag_enable"],
    "sample_nag_scale": GENERATION_DEFAULTS["nag_scale"],
    "sample_nag_tau": GENERATION_DEFAULTS["nag_tau"],
    "sample_nag_alpha": GENERATION_DEFAULTS["nag_alpha"],
    ...
    "dit_partition_training_enabled": False,
    ...
    "dit_partition_profile": False,
    "dit_partition_global_adapter_enabled": False,
    ...
    "qwen_partition_training_enabled": None,
    "qwen_partition_mode": None,
    "qwen_partition_fixed_count": None,
    "qwen_partition_halo_tokens": None,
    "qwen_partition_split_ratio_min": None,
    "qwen_partition_split_ratio_max": None,
    "qwen_partition_seed": None,
    "qwen_partition_gradient_checkpointing_blocks": None,
    "qwen_partition_profile": None,
    "qwen_full_kv_query_chunk_tokens": 0,
    "qwen_partition_global_adapter_enabled": None,
    "qwen_partition_global_rank": None,
    "qwen_partition_global_tokens": None,
    ...
    # the default because a positive value REBUILDS the generation ViT's patch
    # embed and the fm_head's output convolution and every UI edit resends this
    # field. A positive value must be a multiple of 4 (the fm_head's
    # ps1(2)/ps2(2) leave ps3 = P/4). One token covers P * vae_scale_factor
    # pixels, so 4 on an 8x VAE is the pixel model's own 32px geometry and
    # preserves its token count; 8 is 64px per token and a quarter of the
