...
| [docs/guides/SENSENOVA_SDXL_CHIMERA_V3_DESIGN.md](SENSENOVA_SDXL_CHIMERA_V3_DESIGN.md) | Proposed v3 polar path, tangent-only CFG, learned radial flow, one-NFE polar solver, and acceptance gates. |
