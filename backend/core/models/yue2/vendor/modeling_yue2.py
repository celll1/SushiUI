# Adapted from multimodal-art-projection/YuE, Apache-2.0.
# Upstream revision: 88da114a67df892af0329472073b96a5ef700b93.
# Modifications: SushiUI namespace; owned lifecycle and checkpoint loading.
...
class TimestepEmbedder(nn.Module):
    ...
    def forward(self, t):
        ...
        # Packed ConvRot Linear weights and bias are buffers, not Parameters.
        return self.mlp(emb.to(self.mlp[0].bias.dtype))
    ...
    def forward(
        ...
        for i, layer in enumerate(self.layers):
            if self.gradient_checkpointing and self.training:
                ...
                def layer_forward(hidden, _layer=layer, _index=i):
                    return _layer(hidden, cos, sin, None, layer_idx=_index,
                                  attention_mask=attention_mask, ar_mask=ar_mask,
