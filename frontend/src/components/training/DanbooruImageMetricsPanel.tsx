...
import { getTrainingDanbooruMetrics, resumeTrainingDanbooru, DanbooruImageAugMetrics } from "@/utils/api";
...
export default function DanbooruImageMetricsPanel({ runId, active }: Props) {
  ...
  return (
    <div className="bg-gray-900 border border-gray-700 rounded p-3 space-y-3">
      ...
      <DanbooruSpeedStatus data={data} onResume={() => resumeTrainingDanbooru(runId)} />
