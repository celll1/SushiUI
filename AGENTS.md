...
driving 17 generation architectures — 12 image (SD1.5, SDXL, Z-Image, Flux2,
Anima, Lens, Krea2, Qwen-Image 2.1, Ideogram4, MiniT2I, SenseNova U1.5, SenseNova SDXL Chimera), 2 video (LTX-2.3,
...
`backend/core/training/arch/__init__.py` (16 entries — MiniMax Music 3 is
...
| Qwen-Image 2.1 generation or training | `docs/reference/architectures/qwen_image_21.md`, then `docs/guides/QWEN_IMAGE_21_DESIGN.md` for artifact and acceptance details |
...
| Tagger inference, sidecar editing, or training | `docs/guides/TAGGER.md` |
