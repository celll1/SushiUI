...
class Krea2ArchHandler(ArchHandler):
    ...
    def load_components(self, trainer) -> None:
        raise NotImplementedError("krea2.load_components: phase P3")

    def setup_block_swap(self, trainer) -> None:
        raise NotImplementedError("krea2.setup_block_swap: phase P3")

    def setup_attention_backend(self, trainer) -> None:
        raise NotImplementedError("krea2.setup_attention_backend: phase P3")
