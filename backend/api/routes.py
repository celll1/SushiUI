...
async def generate_outpaint(
    ...
    outpaint_seam_offset_prop_corners: bool = Form(OUTPAINT_DEFAULTS["outpaint_seam_offset_prop_corners"]),  # G_prop16 corner-quadrant fill (opt-in); only has effect when outpaint_seam_offset_prop > 0, False = off (byte-identical)
    ...
    try:
        ...
        params = {
            ...
            "outpaint_seam_offset_prop_corners": outpaint_seam_offset_prop_corners,
